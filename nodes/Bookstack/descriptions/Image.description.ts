...
export const imageOperations: INodeProperties[] = [
	{
		...
		options: [
			{ name: 'Create', value: 'create', action: 'Create an image' },
			{ name: 'Delete', value: 'delete', action: 'Delete an image' },
			{ name: 'Get', value: 'get', action: 'Get an image' },
			{ name: 'Get Many', value: 'getAll', action: 'Get many images' },
			{ name: 'Update', value: 'update', action: 'Update an image' },
		],
		default: 'getAll',
	},
];
